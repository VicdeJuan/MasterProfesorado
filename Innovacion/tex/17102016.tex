...
\captionof{figure}{Función ejecutiva (motor del cerebro) y gasolina (Amígdala)}
\label{viramigdala}
\end{minipage}
...
\addimg{\virgicolor}{scale=0.7}{img/viryi3.png}{ Registro de actividad electrodérmica de un universitario durante 24h en su casa y en clase en actividades cotidianas (Poh, Swenson y Picard, 2010)}{estudiomolon}
