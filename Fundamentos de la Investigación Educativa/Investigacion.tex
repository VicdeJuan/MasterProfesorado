...
%
Primero las competencias informáticas con la escala \citetitle{CPSES} \cite{CPSES}, antes del experimento y después, con un grupo de control para comprobar si la mejora producida es significativa mediante un contraste de hipótesis estadístico.
%
...
\textbf{Recogida de datos: } Definiremos 
\begin{itemize}
	...
	\subitem Técnicamente se realizarán \mathtt{n} experimentos con las \mathtt{n} asignaturas elegidas por más de 5 estudiantes.
	\item \textbf{Grupos:}
