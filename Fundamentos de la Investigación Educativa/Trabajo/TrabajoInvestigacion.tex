...
\begin{itemize}
	\item Cómo mejora la autoeficacia \footnote{la definición se encuentra en \ref{defn::autoeficacia}} en la programación (utilizando \citetitle{CPSES}  \cite{CPSES}) gracias a haber estado desarrollando un programa con una utilidad directa.
...
%
Consideramos las 3 medias en el cuestionario \citetitle{CPSES}.
