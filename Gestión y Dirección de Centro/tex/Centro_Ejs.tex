...
Sofía Sabroso es una profesora interina de Matemáticas de 32 años que ha sido llamada para cubrir una sustitución de una funcionaria que se encuentra de baja por maternidad, en el IES Pedro del Valle. 
%
...
Si no llegaran a un acuerdo (en estos términos o en otros), se tendría que informar del caso a la dirección de área territorial y a la inspección para que envíen a las personas necesarias para cubrir la sustitución.
...
El pago en 14 pagas es aceptable. 
%
Las horas de la jornada laboral (25 horas lectivas, 40 de permanencia en el centro) también son aceptables (ya que está especificado en el convenio colectivo).
%
Vigilar el patio puede ser una condición aceptable dependiendo de las responsabilidades de Natalia en el centro. 
%
No es la misma situación si le reducen 1 guardia (ya que cuida 2 recreos) o no se la redujeran.

Trabajar en el mes de Julio también es una condición aceptable según el convenio, ya que sólo se establece 1 mes de vacaciones (que sería el mes de Agosto).
%
La compensación por esas clases es un extra que el centro ha decidido aportar, que no es obligatorio, ya que Natalia va a cobrar su nómina habitual en el mes de Julio.
