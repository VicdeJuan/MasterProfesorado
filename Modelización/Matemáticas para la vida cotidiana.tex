...
\begin{enumerate}
	...
	\begin{table}[hbtp]
		...
		\begin{tabular}{|c|c|c|c|}
			\hline
			a)&b)&c)&d)\\\hline
			\addheight{\includegraphics[scale=0.3]{img/EjemploPendiente01.JPG}}& 
			\addheight{\includegraphics[scale=0.4]{img/EjemploPendiente02.JPG}}& 
			\addheight{\includegraphics[scale=0.5]{img/EjemploPendiente03.JPG}}& 
			\addheight{\includegraphics[scale=0.4]{img/EjemploPendiente04.JPG}}
			\\\hline			
		\end{tabular}
		\caption{}
